...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/layouts/css/adminlte.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/layouts/css/base_layout.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/css/all.min.css')); ?>">
</head>
...
<!-- jQuery -->
<script src="<?php echo e(asset('assets/plugins/js/jquery.min.js')); ?>"></script>
<!-- Bootstrap -->
<script src="<?php echo e(asset('assets/plugins/js/bootstrap.min.js')); ?>"></script>
<!-- AdminLTE -->
<script src="<?php echo e(asset('assets/layouts/js/adminlte.js')); ?>"></script>
</body>
</html>
<?php /**PATH /var/app/app/Providers/../views/layouts//base_layout.blade.php ENDPATH**/ ?>