                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col col-12 col-sm-12 col-lg-3">
                            <div class="search-group">
                                ...
                                <input type="text" name="login" class="form-control form-control-sm search-input"
                                       value="{{isset($search_data['login'])?$search_data['login']:''}}">
                            </div>
                            <div class="search-group">
                                <label class="">ФИО:</label>
                                <input type="text" name="fio" class="form-control form-control-sm search-input"
                                       value="{{isset($search_data['fio'])?$search_data['fio']:''}}">
                            </div>
                            <div class="search-group">
                                <label>Группы:</label>
                        ...
                        <div class="col-12 col-sm-12 col-lg-3">
                            <div class="search-group">
                                ...
                                <input type="text" name="email" class="form-control form-control-sm search-input"
                                       value="{{isset($search_data['email'])?$search_data['email']:''}}">
                            </div>
                            <div class="search-group">
                                <label class="">ИНН:</label>
                                <input type="number" name="inn" class="form-control form-control-sm search-input"
                                       value="{{isset($search_data['inn'])?$search_data['inn']:''}}">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex gap-2">
                        <div class="btn-main ml-auto clear-btn-user-info"><i class="fa fa-times" aria-hidden="true"></i>
                            Очистить
                        </div>
