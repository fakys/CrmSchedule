...
class CorrectionPairForm extends AbstractForm
{
    private CorrectionCardEntity $card;

    public function __construct(string $formTag, FormAdditionalParamInterface $additionalParam, CorrectionCardEntity $card)
    {
        $this->card = $card;
