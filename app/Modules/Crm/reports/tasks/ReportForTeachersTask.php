...
class ReportForTeachersTask extends AbstractTask
{
    ...
    const HEADER =     [
        'Фио преподавателя', 'Логин преподавателя',
        'Название семестра', 'Количество рабочих часов в периоде',
        'Среднее количество часов в неделю',
        'Количество рабочих часов в семестре'
    ];
    ...
    public function Execute($args = []): bool
    {
        ...
        $data = BackendHelper::getOperations()->getReportsForTeachers(
            $args['period'], $args['teachers'] ?? []
        );
